...
import io.lat.ctl.resolver.LatXPathVariableResolver;
...
public class XmlUtil {
	...
	public static Document createDocument(String xmlPath) {
		...
		try {
			...
			throw new LatException("An error occured when creating xml document.", e);
		}
		return document;
	}
	...
	public static Object xpathEvaluate(String expression, Object item, QName returnType, XPath xpath, XpathVariable variables[]) throws XPathExpressionException {
		LatXPathVariableResolver variableResolver = new LatXPathVariableResolver();
	...
	public static void writeXmlDocument(Document document, String xmlPath) {
		try {
			...
			throw new LatException("An error occured when saving file '" + xmlPath + "'", e);
		}
	}
