...
public class FileUtil {
	...
	public static void setShellVariable(String shellFilePath, String name, String value) {
		...
		if (StringUtil.isBlank(variableString)) {
			throw new LatException("Fail to set variable '" + name + "' : '" + shellFilePath + "'");
		}
		else {
	...
	public static void delete(File file) {
		try {
			...
			throw new LatException("Failed to delete file '" + file.getAbsolutePath() + "'", e);
		}
	}
	...
	private static String getShellVariableString(String shellFilePath, String name) {
		...
		try {
			...
			throw new LatException("Fail to read file : '" + shellFilePath + "'", e);
		}
		finally {
			close(br);
		}
	...
	private static void replaceTextInFile(File file, CharSequence target, CharSequence replacement) {
		try {
			...
			throw new LatException("Failed to replace text '" + file.getAbsolutePath() + "'", e);
		}
	}
	...
	public static String readFileToString(File file, String encoding) {
		try {
			...
			throw new LatException("Failed to read file '" + file.getAbsolutePath() + "'", e);
		}
	}
	...
	public static void writeStringToFile(File file, String data, String encoding) {
		try {
			...
			throw new LatException("Failed to write file '" + file.getAbsolutePath() + "'", e);
		}
	}
	...
	public static void copyDirectory(String srcPath, String destPath, FileFilter filter) {
		try {
			...
			throw new LatException("Failed to copy directory '" + srcPath + "', '" + destPath + "'", e);
		}
	}
    ...
    public static void appendStringToFile(String targetFilePath, String appendStr){
        ...
        try {
        	...
        	throw new LatException("Fail to append string to : '" + targetFilePath + "'", ex);
        } finally {
        	close(fos);
        }
    }
