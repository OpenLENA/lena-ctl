...
public class PropertyUtil {
	...
	public static String getProperty(String filePath, String key){
        ...
        try {
        	...
        	throw new LatException("Cannot load property file : '" + filePath + "'", e);
        } finally {
        	FileUtil.close(fis);
        }
	...
	public static void setProperty(String propertyFilePath, String name, String value){
		...
		if(StringUtil.isBlank(variableString)){
			throw new LatException("Fail to set variable '" + name + "' : '"+ propertyFilePath +"'");
		}
		else{
	...
	private static String getPropertyVariableString(String propertyFilePath, String name){
		...
		try{
			...
			throw new LatException("Fail to read file : '"+ propertyFilePath +"'", e);
		}
		finally{
			FileUtil.close(br);
		}
