 ...
 */
public class LatWebServerCloneInstaller extends LatInstaller{
	/**
	 * 기본생성자
	 * @param installCommandType
	 * @param installServerType
	 */
	public LatWebServerCloneInstaller(InstallerCommandType installCommandType, InstallerServerType installServerType) {
