...
This is the home of the LA:T Ctl.
LA:T Ctl help to install servers easily by offering command line interface in LA:T.

The feature of LA:T Ctl : 
...
+ Monitoring : It is possible to capture heap and thread dump using LA:T which means that, you don't need to memorize complicated commands like jmap.
               just do that with simple command of LA:T.
...
## Release
LA:T will be released every each quarter. You can get [released files](https://github.com/OpenLENA/lena-ctl/releases) and check what is changed in [release note](https://github.com/OpenLENA/lena-ctl/releases).

## Roadmap
You can find a roadmap of LA:T Ctl [here](https://github.com/OpenLENA/lena-ctl/wiki/2021-Roadmap).

## Community
[LENA Community](https://groups.google.com/g/openlena)

## License
LA:T Ctl is Open Source software released under the Apache 2.0 license.
